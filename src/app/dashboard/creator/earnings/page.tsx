    ...
    <RoleGuard allowedRoles={["creator"]}>
      <DashboardLayout title="Earnings Vault">
        <div className="space-y-8">
          ...
          <div className="glass p-8 rounded-[40px] border-white/5">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-gray-500 uppercase">Real-time Node Log</span>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="py-20 text-center">
                <div className="text-[10px] text-gray-600 font-black uppercase tracking-widest italic mb-2">No earnings history detected</div>
              ...
              <div className="space-y-4">
                {payments.map((payment) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between p-6 bg-white/5 border border-white/5 rounded-2xl hover:border-white/10 transition-all"
                  >
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-xl ${payment.status === 'completed' ? 'bg-green-500/10 text-green-500' : 'bg-yellow-500/10 text-yellow-500'}`}>
                        <DollarSign size={20} />
                      </div>
                      <div>
                    ...
                    <div className="text-right">
                      <div className="text-sm font-black text-white">₹{(payment.amount / 100).toLocaleString()}</div>
          ...
          {/* Payout Info */}
          <div className="glass p-8 rounded-[40px] border-neon-blue/20 bg-gradient-to-br from-neon-blue/5 to-transparent">
